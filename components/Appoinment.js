                            ...
                            <div role="form" className="wpcf7" id="wpcf7-f5826-p7684-o1" lang="en-US" dir="ltr">
                                ...
                                <form action="https://demo.goodlayers.com/mediz/hospital/#wpcf7-f5826-p7684-o1" method="post" className="wpcf7-form" noValidate="novalidate">
                                    ...
                                    <div className="gdlr-core-input-wrap gdlr-core-large gdlr-core-full-width gdlr-core-with-column gdlr-core-no-border">
                                        <div className="gdlr-core-column-30"><span className="wpcf7-form-control-wrap your-name"><input type="email" name="your-name" value="" size="40" className="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Full Name*" /></span></div>
                                        ...
                                        <div className="gdlr-core-column-30"><span className="wpcf7-form-control-wrap your-email"><input type="email" name="your-email" value="" size="40" className="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Email*" /></span></div>
